	...
	; Compiler options:
	;
	; --ccmode=c18 -q --msgdisable=1414 --asmlist --chip=18F4550 \
	; rm18f4550 - HID Bootload.lkr Objects\PICDEM FSUSB\usb_descriptors.o \
	; Objects\PICDEM FSUSB\main.o Objects\PICDEM FSUSB\usb_function_cdc.o \
	; Objects\PICDEM FSUSB\usb_device.o --lkrmac=_CRUNTIME --lkrmac=_DEBUG \
	; -OUSB Device - CDC - Basic Demo -  C18 - PICDEM FSUSB.cof \
	; -MUSB Device - CDC - Basic Demo -  C18 - PICDEM FSUSB.map
	;
